...
int main(int argc,char* argv[]){
    ...
    int qd=0;int dd=0;
    //reading the frame, warping the frame in the main
    while (true){
...
//common resources - fm_count, doing
//spliting the frame by the y coordinates and calculating queue, dynamic density
void* subtractor(void* dat){
    Mat f_crop;
    Mat fgmask;
    //Mat warp_frame;
